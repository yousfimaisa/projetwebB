...
$avisList = $avisController->lireavis(); 
?>
<html>
<head>
    ...
    <table>
        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-danger" href="lireavis.php?id=<?php echo $avis['id']; ?>&numero=<?php echo $avis['numero']; ?>" onclick="return confirm('Confirmer la suppression ?')">Supprimer</a>
                </td>
            </tr>
            <?php endforeach; ?>
        <?php endif; ?>
